.. bqStart documentation master file, created by
   sphinx-quickstart on Tue Dec  7 17:46:09 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to bqStart's documentation!
===================================
...
.. |customsub| image:: image/pdcl-logo.png
